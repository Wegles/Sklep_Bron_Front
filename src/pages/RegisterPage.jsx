...
const PASSWORD_REGEX = new RegExp('^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%]).{8,32}$');
const USER_REGEX = new RegExp('^[A-z0-9-_]{3,24}$');
          ...
          >
            ...
            >
              <TextField
                ...
                helperText={
                  user && !validName
                    ? `Od 3 do 32 znaków. Litery, cyfry, podkreślniki, myślniki są dozwolone.`
                    : ' '
                }
                fullWidth
                autoComplete="off"
              ...
              <TextField
                ...
                helperText={
                  password && !validPassword
                    ? `Od 8 do 32 znaków. Musi zawierać dużą i małą literę, cyfrę i znak specjalny (!@#$%).`
                    : ' '
                }
                fullWidth
